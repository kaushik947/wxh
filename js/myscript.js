...
if(bug==1)
 ...
 ta=parseInt(speedt.css("top"),10);
		...
		if(((ta+10)>=tt&&(ta+10)<=(tt+hh))&&((la+5<=(ll+ww))&&((la+5)>=ll)))
		{
				hits++;
 ...
 ta=parseInt(speedl.css("top"),10);
		...
		if(((la+10)>=ll&&(la+10)<=(ll+ww))&&((ta+5<=(tt+hh))&&((ta+5)>=tt)))
		{
				hits++;
 ...
 ta=parseInt(speedb.css("top"),10);
		...
		if(((ta)>=tt&&(ta)<=(tt+hh))&&((la+5<=(ll+ww))&&((la+5)>=ll)))
		{
				hits++;
 ...
 ta=parseInt(speedr.css("top"),10);
		...
		if(((la)>=ll&&(la)<=(ll+ww))&&((ta+5<=(tt+hh))&&((ta+5)>=tt)))
		{
				hits++;
